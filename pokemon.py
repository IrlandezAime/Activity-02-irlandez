...
print ("Feraligatr LVL = 95, SDef = 188 \nCharizard uses Fire Blast to Feraligatr")
...
raaaan = .85,1
raan = random.choice(raaaan)
Stab = 1
Type = 1
Burn = 1
Other = 1
Modifier = Targets * Weather * Badge * crit * raan * Stab * Type * Burn * Other


if crit == 2:
    print ("        Sheeeeeeeeeeeesh nice crit       ")
